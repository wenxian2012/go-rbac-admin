...
import (
	...
	"github.com/wenxian2012/go-rbac-admin/middleware/jwt"
	"github.com/wenxian2012/go-rbac-admin/middleware/permission"
	"github.com/wenxian2012/go-rbac-admin/pkg/setting"
	"github.com/wenxian2012/go-rbac-admin/routers/api"
	v1 "github.com/wenxian2012/go-rbac-admin/routers/api/v1"
)
...
func InitRouter() *gin.Engine {
	...
	r.Use(gin.Logger())           // 日志
	r.Use(Cors())                 // 跨域请求
	r.Use(errors.ValidateError()) // 错误处理
	r.Use(gin.Recovery())
	gin.SetMode(setting.ServerSetting.RunMode)

	r.POST("/api/account/login", api.Auth)                               // 获取登录token
	...
	{
		apiV1.GET("/account/token", api.Token)

		apiV1.GET("/menus-tree", v1.GetTree)
